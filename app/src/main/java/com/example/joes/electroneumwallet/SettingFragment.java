...
public class SettingFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        Preference preference = findPreference(getString(R.string.pref_wallet_address_key));
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        ...
        String sizeKey = getString(R.string.pref_wallet_address_key);
